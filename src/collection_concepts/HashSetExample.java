...
public class HashSetExample {
		...
		public void basicExamplesHashSet(){
			...
			boolean adding_A_1st_time= hashSet.add("A");
			System.out.println(adding_A_1st_time);
			
			hashSet.add("D");
			hashSet.add("E");
			hashSet.add("F");
			
			boolean adding_A_2nd_time =hashSet.add("A"); // the return type of add() is boolean. Since A is already there it will return false and wont add
			System.out.println(adding_A_2nd_time);
